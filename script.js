...
// 2. Write a function that takes the radius of a circle and outputs its approximate circumference (the formula for circumference is 2 * pi * radius, you may use 3.14 for pi).
